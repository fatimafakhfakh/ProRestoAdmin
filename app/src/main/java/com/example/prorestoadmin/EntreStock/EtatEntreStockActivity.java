package com.example.prorestoadmin.EntreStock;
...
import com.example.prorestoadmin.EntreStock.task.EtatBonEntreeTask;
import com.example.prorestoadmin.R ;
import com.example.prorestoadmin.task.EtatMouvementStockEnteeEntreeSortieTask;
...
public class EtatEntreStockActivity extends AppCompatActivity {


    public static ProgressBar pb;
    public static RecyclerView rv_list_bon_entree;
    ...
    public static RecyclerView rv_list_tot_production;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_etat_entre_stock);
        ...
        rv_list_tot_production  = findViewById( R.id.rv_list_tot_production ) ;
        rv_list_tot_production.setHasFixedSize(true);
        rv_list_tot_production.setLayoutManager(new LinearLayoutManager(this));
        ...
        txt_date_debut.setOnClickListener(new View.OnClickListener  ()  {
            ...
            public void onClick(View v)  {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(EtatEntreStockActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
  ...
  public   void   updateData ()
  {
      ...
      EtatMouvementStockEnteeEntreeSortieTask  etatMouvementStockEnteeEntreeSortieTask =  new EtatMouvementStockEnteeEntreeSortieTask(EtatEntreStockActivity.this , date_debut , date_fin, rv_list_tot_production , "EtatEntreStockActivity");
      etatMouvementStockEnteeEntreeSortieTask.execute() ;

      EtatBonEntreeTask etatBonLivraisonTask = new EtatBonEntreeTask(EtatEntreStockActivity.this , date_debut , date_fin , rv_list_bon_entree  ,pb) ;
      etatBonLivraisonTask.execute() ;
