...
import com.example.prorestoadmin.ui.caisse.MouvementCaisseRecetteActivity;
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.card_caisse.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent  toMouvementCaisseDepense =  new Intent (activity , MouvementCaisseRecetteActivity.class) ;

                toMouvementCaisseDepense.putExtra("cle_code_compte",caisse.getCodeCompte()) ;
                toMouvementCaisseDepense.putExtra("cle_libelle_compte",caisse.getNomCompte()) ;

                activity.startActivity(toMouvementCaisseDepense);
            }
        });
