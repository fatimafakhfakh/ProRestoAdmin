...
public class MouvementCaisseRecetteGlobalTask extends AsyncTask<String, String, String> {
  ...
  double  solde_en_cours = 0 ;
    ...
    public MouvementCaisseRecetteGlobalTask(Activity activity, ListView lv_list_mvmnt_caisse_recette, ProgressBar pb_chargement, String codeCompte, Date date_debut, Date date_fin) {
        ...
        try {
            ...
            if (con == null) {
                ...
                String query = "DECLARE\t@return_value int\n" +
                        "\n" +
                        "EXEC\t@return_value = [dbo].[FicheCompte]\n" +
