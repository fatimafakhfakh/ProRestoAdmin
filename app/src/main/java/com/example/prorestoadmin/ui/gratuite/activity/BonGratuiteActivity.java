...
public class BonGratuiteActivity extends AppCompatActivity {

    public static ProgressBar pb;
    public static RecyclerView rv_list_bon_gratuite;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bon_gratuite);
        ...
        rv_list_bon_gratuite = (RecyclerView) findViewById(R.id.rv_list_bon_gratuite);
        pb = (ProgressBar) findViewById(R.id.pb);
        search_bar_client = (SearchView) findViewById(R.id.search_bar_client);

        rv_list_bon_gratuite.setHasFixedSize(true);
        rv_list_bon_gratuite.setLayoutManager(new LinearLayoutManager(this));
        ...
        txt_date_debut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(BonGratuiteActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
