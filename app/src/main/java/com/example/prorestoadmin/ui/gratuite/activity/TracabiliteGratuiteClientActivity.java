...
import com.example.prorestoadmin.ui.gratuite.task.EtatBonGratuiteTask;
import com.example.prorestoadmin.ui.gratuite.task.ListClientTracabiliteTask;
...
public class TracabiliteGratuiteClientActivity extends AppCompatActivity {


    public static ProgressBar pb;
    public static RecyclerView rv_list_trace;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tracabilite_gratuite_client);
        ...
        rv_list_trace = (RecyclerView) findViewById(R.id.rv_list);
        ...
        rv_list_trace.setHasFixedSize(true);
        rv_list_trace.setLayoutManager(new LinearLayoutManager(this));


        ListClientTracabiliteTask  listClientTracabiliteTask = new ListClientTracabiliteTask(this , sp_client) ;
        listClientTracabiliteTask.execute() ;
        ...
        txt_date_debut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(TracabiliteGratuiteClientActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
