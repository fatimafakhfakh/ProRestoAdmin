package com.example.prorestoadmin.ui.parametrage;
...
import com.example.prorestoadmin.activity.ParametrageActivity;
import com.example.prorestoadmin.activity.SplachScreenActivity;
import com.example.prorestoadmin.connexion.StaticValues;
import com.example.prorestoadmin.ui.notifications.NotificationsViewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        btn_disconnect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SharedPreferences pref = getActivity().getSharedPreferences(StaticValues.PREF_USER, Context.MODE_PRIVATE);
