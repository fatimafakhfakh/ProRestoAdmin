...
public class BonLivraisonActivity extends AppCompatActivity {
    ...
    public static RecyclerView rv_list_bon_livraison;
   ...
   SearchView search_bar_client ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rv_list_bon_livraison   = (RecyclerView) findViewById(R.id.rv_list_bon_transfert);
        pb = (ProgressBar) findViewById(R.id.pb);
        search_bar_client = (SearchView) findViewById(R.id.search_bar_client);

        rv_list_bon_livraison.setHasFixedSize(true);
        rv_list_bon_livraison.setLayoutManager(new LinearLayoutManager(this));
        ...
        EtatBonLivraisonTask  etatBonLivraisonTask = new EtatBonLivraisonTask(BonLivraisonActivity.this , date_debut , date_fin , rv_list_bon_livraison  ,pb,search_bar_client) ;
        ...
        txt_date_debut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(BonLivraisonActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
